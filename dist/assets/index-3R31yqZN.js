...
`);return`
  ...
  `}function Ng(){const e=_l(),t=q(),n=xl();document.querySelector("#app").innerHTML=`
    ...
    ${_()}
  `,Yg()}function Yg(){Vg(),Ug()}function Vg(){const e=document.getElementById("loadMore");e&&e.addEventListener("click",()=>{document.querySelector(".games-grid")})}function Ug(){const e=document.querySelector(".hamburger-menu"),t=document.querySelector(".mobile-menu");e&&t&&e.addEventListener("click",()=>{e.classList.toggle("active"),t.classList.toggle("hidden"),t.classList.toggle("active")})}function te(e){return`
    <div class="bg-black">
  ...
  `}function Jg(){const e=q();let t=1;const n=6;function o(){const l=t*n,g=document.querySelector(".news-grid");g.innerHTML=e.slice(0,l).map(p=>te(p)).join("");const h=document.querySelector("#loadMoreNews");l>=e.length&&(h.style.display="none")}document.querySelector("#app").innerHTML=`
    ${k()}
...
`).map(t=>`<p class="mb-4 leading-relaxed font-normal text-[0.8 rem]">${t.trim()}</p>`).join(""):""}function Zg(e){const t=q(),n=t.find(g=>g.slug===e.slug),o=t.filter(g=>g.slug!==e.slug),s=3;let i=1;if(!n){window.location.href="/news";return}document.querySelector("#app").innerHTML=`
    ${k()}
    ...
    ${_()}
  `,eu(),l();function l(){const g=document.getElementById("loadMoreNews"),h=document.getElementById("latestNewsContainer");g&&g.addEventListener("click",()=>{i++;const p=0,b=i*s;h.innerHTML=o.slice(p,b).map(ne).join(""),b>=o.length&&(g.style.display="none")})}}function eu(){const e=document.querySelector(".hamburger-menu"),t=document.querySelector(".mobile-menu");e&&t&&e.addEventListener("click",()=>{e.classList.toggle("active"),t.classList.toggle("hidden"),t.classList.toggle("active")})}let H=1;const z=15,tu=e=>{const t=Math.random().toString(36).substring(2)+Date.now().toString(36),n="https://cdn-demo.spinart.cloud/peterandsons/launcher/index.html",o=new URLSearchParams({server:"https://demo.spinart.cloud",wallet:"demo",operator:"demo",gameCode:e,key:t});return`${n}?${o.toString()}`};function nu(e){const t=e.filter(n=>n.bannerBackground&&n.bannerBackground!==""&&n.bannerLogo&&n.bannerLogo!=="").slice(0,4);return t.length===0?"":`
  ...
  `}function ou(e){const n=H*z,o=document.querySelector(".games-grid");o.innerHTML=e.slice(0,n).map(i=>Ll(i)).join("");const s=document.querySelector("#loadMoreGames");s&&n>=e.length&&(s.style.display="none"),Bl()}function au(){const e=_l().sort((t,n)=>new Date(n.releaseDate)-new Date(t.releaseDate));H=1,document.querySelector("#app").innerHTML=`
    ${k()}
    ...
    ${_()}
  `,su(),iu(e),ru(),Bl()}function Bl(){document.querySelectorAll(".game-card").forEach(t=>{const n=t.querySelector(".game-buttons"),o=n.querySelector(".more-btn"),s=n.querySelector(".action-buttons"),i=n.querySelector(".play-btn");o.addEventListener("click",l=>{l.stopPropagation(),o.style.display="none",s.style.display="flex",n.dataset.state="expanded"}),s.addEventListener("mouseenter",()=>{n.dataset.state==="expanded"&&(o.style.display="none",s.style.display="flex")}),t.addEventListener("mouseleave",()=>{n.dataset.state==="expanded"&&(o.style.display="block",s.style.display="none",n.dataset.state="initial")}),i&&i.addEventListener("click",l=>{l.stopPropagation();const g=l.target.getAttribute("data-game-id");if(g){const h=tu(g);window.open(h,"_blank")}})})}function su(){let e=0;const t=document.querySelector(".hero-slider"),n=document.querySelectorAll(".slider-dot"),o=document.querySelectorAll(".hero-slide"),s=document.querySelectorAll(".banner-logo"),i=o.length;if(!t||i===0)return;function l(p){s[p].classList.remove("translate-y-full","opacity-0")}function g(p){s[p].classList.add("translate-y-full","opacity-0")}function h(p){g(e),e=p,t.style.transform=`translateX(-${e*100}%)`,n.forEach((b,w)=>{b.classList.toggle("opacity-100",w===e),b.classList.toggle("opacity-50",w!==e)}),setTimeout(()=>l(e),500)}setTimeout(()=>l(0),500),setInterval(()=>{h((e+1)%i)},5e3),n.forEach((p,b)=>{p.addEventListener("click",()=>h(b))})}function iu(e){const t=document.querySelector("#loadMoreGames");t&&t.addEventListener("click",()=>{H++,ou(e)})}function ru(){const e=document.querySelector(".hamburger-menu"),t=document.querySelector(".mobile-menu");e&&t&&e.addEventListener("click",()=>{e.classList.toggle("active"),t.classList.toggle("hidden"),t.classList.toggle("active")})}function C(e,t,n="up"){return`
    <div class="relative h-32 overflow-hidden -mt-16 -mb-16">
      <div class="absolute inset-0" style="background-color: ${e}"></div>
      <div class="absolute inset-0 transform ${n==="up"?"-skew-y-2":"skew-y-2"} translate-y-1/2 origin-center" style="background-color: ${t}"></div>
    </div>
  `}function lu(){document.querySelector("#app").innerHTML=`
    ${k()}
    <main class="pt-24">
      <!-- Hero Banner -->
    ...
    ${_()}
  `,cu()}function cu(){const e=document.querySelector(".hamburger-menu"),t=document.querySelector(".mobile-menu");e&&t&&e.addEventListener("click",()=>{e.classList.toggle("active"),t.classList.toggle("hidden"),t.classList.toggle("active")})}function P(e,t,n="up"){return`
    <div class="relative h-32 overflow-hidden -mt-16 -mb-16">
      <div class="absolute inset-0" style="background-color: ${e}"></div>
      <div class="absolute inset-0 transform ${n==="up"?"-skew-y-2":"skew-y-2"} translate-y-1/2 origin-center" style="background-color: ${t}"></div>
    </div>
  ...
  `}function gu(){const e=xl(),t=Ag();let n=10,o=10;document.querySelector("#app").innerHTML=`
    ${k()}
    <main class="pt-32 bg-black">
      <!-- Hero Banner -->
      <div class="news-title-container py-20 mb-20 bg-center bg-cover" style="background-image: url('https://peterandsonsgames.com/wp-content/uploads/2023/08/Footer-image-main-03-03-2.png'); background-size: 100% 100%; transform: scaleY(-1)">
    ...
    ${_()}
  `,uu(e,t),pu()}function uu(e,t){let n=10,o=10;const s=document.getElementById("loadMorePartners"),i=document.getElementById("loadMoreFriends");s&&s.addEventListener("click",()=>{n+=10,document.getElementById("partnersGrid").innerHTML=D(e,n),n>=e.length&&(s.style.display="none")}),i&&i.addEventListener("click",()=>{o+=10,document.getElementById("friendsGrid").innerHTML=D(t,o),o>=t.length&&(i.style.display="none")})}function pu(){const e=document.querySelector(".hamburger-menu"),t=document.querySelector(".mobile-menu");e&&t&&e.addEventListener("click",()=>{e.classList.toggle("active"),t.classList.toggle("hidden"),t.classList.toggle("active")})}function oe(e,t,n="up"){return`
    <div class="relative h-32 overflow-hidden -mt-16 -mb-16">
      <div class="absolute inset-0" style="background-color: ${e}"></div>
      <div class="absolute inset-0 transform ${n==="up"?"-skew-y-2":"skew-y-2"} translate-y-1/2 origin-center" style="background-color: ${t}"></div>
    </div>
  ...
  `}function bu(){document.querySelector("#app").innerHTML=`
    ${k()}
    <main class="pt-32 bg-black">
      <!-- Hero Banner -->
...
></iframe>
  ...
  `}function wu(){const e=$l();document.querySelector("#app").innerHTML=`
    ${k()}
    <main class="pt-32 bg-black">
      <!-- Hero Banner -->
    ...
    ${_()}
  `,yu()}function yu(){const e=document.querySelector(".hamburger-menu"),t=document.querySelector(".mobile-menu");e&&t&&e.addEventListener("click",()=>{e.classList.toggle("active"),t.classList.toggle("hidden"),t.classList.toggle("active")})}function ku(e){const n=$l().find(o=>o.title.toLowerCase().replace(/\s+/g,"-")===e.slug);if(!n){window.location.href="/careers";return}document.querySelector("#app").innerHTML=`
    ${k()}
    <main class="pt-32 bg-black">
      <!-- Hero Banner -->
      <div class="py-20 mb-20 bg-center bg-cover" style="background-image: url('https://peterandsonsgames.com/wp-content/uploads/2023/08/Footer-image-main-03-03-2.png'); background-size: 100% 100%; transform: scaleY(-1)">
    ...
    ${_()}
  `,_u()}function _u(){const e=document.querySelector(".hamburger-menu"),t=document.querySelector(".mobile-menu");e&&t&&e.addEventListener("click",()=>{e.classList.toggle("active"),t.classList.toggle("hidden"),t.classList.toggle("active")})}const Sl=new mc("/");function y(e,t=null){window.scrollTo(0,0),t?e(t):e()}Sl.on("/",()=>{y(Ng)}).on("/news",()=>{y(Jg)}).on("/news/:slug",({data:e})=>{y(Zg,e)}).on("/games",()=>{y(au)}).on("/about",()=>{y(lu)}).on("/partners",()=>{y(gu)}).on("/contact",()=>{y(bu)}).on("/careers",()=>{y(wu)}).on("/careers/:slug",({data:e})=>{y(ku,e)}).resolve();document.addEventListener("click",e=>{const t=e.target.closest("[data-navigo]");t&&(e.preventDefault(),Sl.navigate(t.getAttribute("href")))});
